        ...
        <section className="text-gray-600 body-font overflow-hidden">
            <div className="container px-5 py-16 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-64 px-24 lg:px-28 object-cover object-top rounded" src="/img/mug.webp" />
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="pincode flex justify-center md:justify-start mt-10">
                            ...
                            <button onClick={checkService} className="flex ml-8 text-white bg-orange-500 border-0 py-2 px-6 focus:outline-none hover:bg-orange-600 rounded">Check</button>
                        </div>
