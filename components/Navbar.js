    ...
    <div className="sticky top-0 bg-white flex flex-col justify-center items-center md:flex-row md:justify-start shadow-lg">
      ...
      <div className="nav md:ml-10 flex">
        <ul className="flex items-center space-x-2 font-bold md:text-2xl ">
          <Link href={"/tshirts"}>
            <a className="hover:bg-slate-300 rounded-2xl">
              <li className="m-5 mx-2 md:my-2 p-2 active:bg-slate-300 ">
                Tshirts
              </li>
            </a>
          </Link>
          <Link href={"/mugs"}>
            <a className="hover:bg-slate-300 rounded-2xl">
              <li className="m-5 mx-2 md:my-2 p-2 active:bg-slate-300 ">Mug</li>
            </a>
          </Link>
          <Link href={"/about"}>
            <a className="hover:bg-slate-300 rounded-2xl">
      ...
      <div
        onClick={toggalChart}
        className=" cursor-pointer cart absolute right-0 top-7 mx-7 hover:text-red-600 "
      >
        <AiOutlineShoppingCart className="text-2xl hover:text-3xl md:text-3xl md:hover:text-4xl" />
      </div>
      <div
        ref={ref}
        className={`h-[100vh] sideCart absolute top-7 right-0 bg-white rounded-md border py-10 pl-10 pr-2 w-80 transform transition-transform ${
      ...
      >
        ...
        <span
          onClick={toggalChart}
          className=" hover:text-orange-500 hover:shadow-2xl text-2xl absolute top-4 right-8  cursor-pointer text-orange-400 "
        >
          <AiFillCloseCircle />
        </span>
        ...
        <div className="flex mt-5 ">
          <Link href={"/checkout"}>
            <button className="flex  text-white bg-orange-500 border-0 py-2 px-3 focus:outline-none hover:bg-orange-600 rounded text-lg">
          ...
          <button
            onClick={clearCart}
            className="flex mx-auto  text-white bg-orange-500 border-0 py-2 px-3 focus:outline-none hover:bg-orange-600 rounded text-lg"
          >
            Clear Cart
          </button>
        </div>
